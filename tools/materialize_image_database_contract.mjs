...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_image_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'image_', owner: 'image-platform', domain: 'image' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into image database contract\n`);
