...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/image-backend-sdk" }
        "dart" { return "sdkwork_image_backend_sdk" }
        "flutter" { return "sdkwork_image_backend_sdk" }
        "python" { return "sdkwork-image-backend-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-image-backend-sdk" }
        "java" { return "com.sdkwork:sdkwork-image-backend-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-image-backend-sdk" }
        "swift" { return "sdkwork-image-backend-sdk" }
        "csharp" { return "SDKWork.Image.BackendSdk" }
        "rust" { return "sdkwork-image-backend-sdk" }
        "php" { return "sdkwork/image-backend-sdk" }
        "ruby" { return "sdkwork-image-backend-sdk" }
        default { return "sdkwork-image-backend-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.image.backend.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.image.backend.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Image.BackendSdk") }
        "php" { return @("--namespace", "SDKWork\Image\BackendSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-image-backend-api.sdkgen.yaml"
$SdkName = "sdkwork-image-backend-sdk"
