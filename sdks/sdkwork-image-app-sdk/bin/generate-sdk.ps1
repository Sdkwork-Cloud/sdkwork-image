...
function Resolve-PackageName {
    ...
    switch ($Language) {
        "typescript" { return "@sdkwork/image-app-sdk" }
        "dart" { return "sdkwork_image_app_sdk" }
        "flutter" { return "sdkwork_image_app_sdk" }
        "python" { return "sdkwork-image-app-sdk" }
        "go" { return "github.com/sdkwork/sdkwork-image-app-sdk" }
        "java" { return "com.sdkwork:sdkwork-image-app-sdk" }
        "kotlin" { return "com.sdkwork:sdkwork-image-app-sdk" }
        "swift" { return "sdkwork-image-app-sdk" }
        "csharp" { return "SDKWork.Image.AppSdk" }
        "rust" { return "sdkwork-image-app-sdk" }
        "php" { return "sdkwork/image-app-sdk" }
        "ruby" { return "sdkwork-image-app-sdk" }
        default { return "sdkwork-image-app-sdk-$Language" }
    }
}
...
function Resolve-NamespaceArgs {
    ...
    switch ($Language) {
        "java" { return @("--namespace", "com.sdkwork.image.app.sdk") }
        "kotlin" { return @("--namespace", "com.sdkwork.image.app.sdk") }
        "csharp" { return @("--namespace", "SDKWork.Image.AppSdk") }
        "php" { return @("--namespace", "SDKWork\Image\AppSdk") }
        default { return @() }
    }
}
...
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-image-app-api.sdkgen.yaml"
$SdkName = "sdkwork-image-app-sdk"
