...
This directory is the local standards index for `@sdkwork/generation-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/generation-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-image/packages/pc-react/content/sdkwork-generation-pc-react` |
| Domain | `content` |
