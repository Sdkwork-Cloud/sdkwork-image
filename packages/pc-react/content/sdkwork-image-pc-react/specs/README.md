# SDKWork Image PC React Component Specs

This directory is the local standards index for `@sdkwork/image-pc-react`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/image-pc-react` |
| Type | `react-package` |
| Root | `sdkwork-image/packages/pc-react/content/sdkwork-image-pc-react` |
| Domain | `content` |
| Capability | `image` |
...
- `pnpm --filter @sdkwork/image-pc-react typecheck`
