...
Domain: content
Capability: image-http
Package type: web-backend-service
Status: standard

This README is the SDKWork module entrypoint for `sdkwork_image_http`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
