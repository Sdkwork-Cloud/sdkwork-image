...
This directory is the local SDKWork component contract for `sdkwork_image_storage_sqlx`.

- Component root: `sdkwork-image/packages/native-rust/image/sdkwork-image-storage-sqlx-rust`
