use sdkwork_router_image_open_api::{open_api_routes, open_route_manifest};
...
fn image_open_route_manifest_matches_metadata_routes() {
    ...
    for entry in &routes {
        let method = match entry.method {
            sdkwork_router_image_open_api::HttpMethod::Get => "GET",
            sdkwork_router_image_open_api::HttpMethod::Post => "POST",
            sdkwork_router_image_open_api::HttpMethod::Patch => "PATCH",
            sdkwork_router_image_open_api::HttpMethod::Delete => "DELETE",
            sdkwork_router_image_open_api::HttpMethod::Put => "PUT",
        };
