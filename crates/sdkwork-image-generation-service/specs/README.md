...
This directory is the local SDKWork component contract for `sdkwork_image_generation_service`.

- Component root: `sdkwork-image/crates/sdkwork-image-generation-service`
