...
This directory is the local SDKWork component contract for `sdkwork_image_generation_workflow_service`.

- Component root: `sdkwork-image/crates/sdkwork-image-generation-workflow-service`
