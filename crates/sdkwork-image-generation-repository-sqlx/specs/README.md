...
This directory is the local SDKWork component contract for `sdkwork_image_generation_repository_sqlx`.

- Component root: `sdkwork-image/crates/sdkwork-image-generation-repository-sqlx`
