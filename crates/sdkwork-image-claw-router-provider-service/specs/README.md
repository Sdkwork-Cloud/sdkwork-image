...
This directory is the local SDKWork component contract for `sdkwork_image_claw_router_provider_service`.

- Component root: `sdkwork-image/crates/sdkwork-image-claw-router-provider-service`
