...
This directory is the local standards index for `@sdkwork/image-pc`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/image-pc` |
| Type | `react-package` |
| Root | `sdkwork-image/apps/sdkwork-image-pc/packages/sdkwork-image-pc` |
| Domain | `content` |
| Capability | `image` |
