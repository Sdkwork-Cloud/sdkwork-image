...
export type SdkworkImageVisualTone = SdkworkThemeVisualTone;

export function createSdkworkImageToneStyle(
  tone: SdkworkImageVisualTone,
  options: {
...
export function createSdkworkImagePanelStyle(
  tone: SdkworkImageVisualTone,
  options: {
    backgroundWeight?: number;
    borderWeight?: number;
...
export function createSdkworkImageBackdropStyle(): CSSProperties {
  return createSdkworkBackdropStyle();
}

export function createSdkworkImageHeroStyle(): CSSProperties {
  return createSdkworkHeroStyle();
}

export function createSdkworkImageHeroTextStyle(
