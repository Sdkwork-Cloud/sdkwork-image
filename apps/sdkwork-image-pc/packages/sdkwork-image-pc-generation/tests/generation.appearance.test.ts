...
describe("sdkwork-generation-pc-react appearance", () => {
  it("exports theme-driven tone styles for reusable generation chips and accents", () => {
    const createToneStyle = (generationModule as Record<string, any>).createSdkworkGenerationToneStyle;
    const createHeroTextStyle = (generationModule as Record<string, any>).createSdkworkGenerationHeroTextStyle;
  ...
  it("exports layered Sdkwork-style generation gradients for hero and panel surfaces", () => {
    const createPanelStyle = (generationModule as Record<string, any>).createSdkworkGenerationPanelStyle;
    const createHeroStyle = (generationModule as Record<string, any>).createSdkworkGenerationHeroStyle;
    const createBackdropStyle = (generationModule as Record<string, any>).createSdkworkGenerationBackdropStyle;
