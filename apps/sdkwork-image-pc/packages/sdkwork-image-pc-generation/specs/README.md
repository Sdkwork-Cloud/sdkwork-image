# SDKWork Generation PC React Component Specs

This directory is the local standards index for `@sdkwork/image-pc-generation`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/image-pc-generation` |
| Type | `react-package` |
| Root | `sdkwork-image/apps/sdkwork-image-pc/packages/sdkwork-image-pc-generation` |
| Domain | `content` |
